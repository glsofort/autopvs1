...
def get_candidates(record_csq, csq_fields, genome_version):
    """
...
def pick_transcript(record, csq_fields, summary, genome_version):
    ...
    """
    candidate_csqs, tx_candidates, pick = get_candidates(record.info['CSQ'], csq_fields, genome_version)
...
def main():
    ...
    parser.add_argument('--threads', help='Threads to be used')
    parser.add_argument('--genome_version', help='Support both hg38 and hg19')
